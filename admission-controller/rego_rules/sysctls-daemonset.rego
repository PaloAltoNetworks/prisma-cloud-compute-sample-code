# PolicyName:  PSS - Baseline - DaemonSet with containers that does not use safe sysctls
# Description: This policy identifies DaemonSets with containers that does not use safe sysctls
...
match[{"msg": msg}] {
    ...
    msg := sprintf("DaemonSet with containers using unsafe sysctls identified in %v", [name])
}
